...
def name_img2gt(img_name):
    gt_name = img_name #.replace('.tiff', '.png')
    return gt_name
...
def gt_255to1(gts_path):
    with tqdm(glob.glob(os.path.join(gts_path, '*.png'))) as pbar:
        for gt_path in pbar:
...
if __name__ == '__main__':
    ...
    gt_dir = r'/home/aistudio/data/src/C2Seg_AB/train/label'
    dst_path = r'/home/aistudio/work/AB_train.txt'
    dataset_split(img1_dir, img2_dir, dst_path, gt_dir)
    ...
    dst_path = r'/home/aistudio/work/BW_train.txt'
    dataset_split(img1_dir, img2_dir, dst_path, gt_dir)
